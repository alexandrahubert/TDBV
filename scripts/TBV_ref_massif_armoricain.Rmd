...
Le rapport de forme (largeur à plein bord / hauteur à plein bord) est, en moyenne, inférieur dans le jeu de données "Jan & Bossis" en comparaison des deux autres jeux de données ("Galineau" et "Carhyce").
