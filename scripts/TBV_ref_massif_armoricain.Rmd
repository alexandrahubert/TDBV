...
```{r, echo = FALSE}
htmltools::img(src = knitr::image_uri('../scripts/logo_OFB.jpg'),
               alt = 'logo',
...
- le jeu de données « têtes de bassins de référence » issues des travaux de Jan (2013) et Bossis (2014) sur des cours d’eau de rang 1 (n=`r n_sites_par_source[3,2]`  stations) ;
- le jeu de données issues des travaux de Galineau (2020) sur des cours d’eau intermédiares de rang 1 à 4 (n=`r n_sites_par_source[2,2]` stations)  ;
- le jeu de données issues de Carhyce, concernant des cours d’eau plus importants, de rang 1 à X (n=`r n_sites_par_source[1,2]` stations). 
